...
*/
    public static void main(String[] args) {
        ...
        if(attemptNumber ==1){
            finalGrade = grade * 0.9; //90% of grade, wich is  minus 10%
        }else if(attemptNumber == 2){
            finalGrade = grade * 0.8; // 80% of grade. wich is minus 20%
        }else if(attemptNumber ==3){
            finalGrade = grade * 0.65; // 65% of grade, wich is minus 35%
        }
        System.out.println(finalGrade); // we can use: garde - grade * 10%
                                         //grade - grade *20 // grade - grade *35%
    }
}

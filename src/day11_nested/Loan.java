...
*/
    public static void main(String[] args) {
        ...
        String result = creditScore > 700? "Loan approved" : "Loan rejected: Sigh up for our credit program";
        System.out.println(result);
        /*
        the boolean creditScore > 700 is checked
        if the boolean is true the value before the colon is returned : Loan Aproved
        if the boolean is false the value before the colon is returned : loan rejected
         */

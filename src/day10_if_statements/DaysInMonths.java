...
use the following data to help you determine the number of days in each month:
    ...
    public static void main(String[] args) {
        ...
        //multi brunch is determine the number of days in each month
        if(has31Days) {
            day = 31;
            ...
            //}else{
            //if i am in this block, it means the month number was not egual to any number
        }
        if(day>0){
            System.out.println("Month: " + month);
            System.out.println("Days in a month: " + day);
        }else{

...
public class Library {
    public static void main(String[] args) {
        ...
        //book1 has acces to 6 variables: author, hasMovie, title, genre, chapters, numberOfPages

        AudioBook book2 = new AudioBook();
        book2.duration = 45.20;
        book2.narrator = "James Bond";
        book2.hasMovie = true;
        // book2 has acces to 8 variables. All the variables from the parent Book class and the two variables declared in the AudioBook class
